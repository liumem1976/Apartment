...
def upgrade():
    op.create_table(
        ...
        sa.Column('bill_id', sa.Integer(), sa.ForeignKey('bill.id', ondelete='SET NULL'), nullable=True),
        sa.Column('unit_id', sa.Integer(), sa.ForeignKey('unit.id', ondelete='SET NULL'), nullable=True),
